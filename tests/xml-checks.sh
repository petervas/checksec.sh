...
"${PARENT}"/checksec.sh --format=xml --proc-all > "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --proc-all --extended > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --kernel > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --kernel=kernel.config > "${DIR}"/output.xml
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
while read -r file; do
  ...
  "${PARENT}"/checksec.sh --format=xml --kernel="${file}" > "${DIR}/output.xml"
  xmllint --noout "${DIR}/output.xml"
  RET=$?
  if [ ${RET} != 0 ]; then
    cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --file="${test_file}" > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --file="${test_file}" --extended > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --fortify-file="${test_file}" > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --fortify-file="${test_file}" --extended > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --fortify-proc=1 > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --fortify-proc=1 --extended > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
...
"${PARENT}"/checksec.sh --format=xml --dir=/sbin > "${DIR}/output.xml"
xmllint --noout "${DIR}/output.xml"
RET=$?
if [ ${RET} != 0 ]; then
  cat "${DIR}/output.xml"
